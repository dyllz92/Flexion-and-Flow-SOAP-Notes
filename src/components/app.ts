...
<body>
  ...
  const MUSCLES = [
    ...
    { id:'pec_major_l', name:'Pectoralis Major (L)', group:'Chest', view:'anterior',
      points:'200,186 196,176 186,169 172,165 156,165 140,169 126,177 114,189 106,204 104,221 109,238 120,252 136,262 154,267 171,266 184,260 194,248 199,233 200,217' },
    { id:'pec_major_r', name:'Pectoralis Major (R)', group:'Chest', view:'anterior',
      points:'200,186 204,176 214,169 228,165 244,165 260,169 274,177 286,189 294,204 296,221 291,238 280,252 264,262 246,267 229,266 216,260 206,248 201,233 200,217' },
    // BICEPS
    ...
    { id:'adductors_l', name:'Adductors (L)', group:'Thigh', view:'anterior',
      points:'192,502 188,522 185,548 183,578 183,608 185,635 190,650 196,655 196,635 195,608 194,578 194,548 195,522 194,508' },
    { id:'adductors_r', name:'Adductors (R)', group:'Thigh', view:'anterior',
      points:'208,502 212,522 215,548 217,578 217,608 215,635 210,650 204,655 204,635 205,608 206,578 206,548 205,522 206,508' },
