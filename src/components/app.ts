...
<body>
  ...
  points:'198,160 188,162 175,165 160,170 145,177 130,187 118,198 110,212 112,228 120,242 132,252 148,258 165,258 180,253 192,244 198,232 200,215 200,198' },
    { id:'pec_major_r', name:'Pectoralis Major (R)', group:'Chest', view:'anterior',
  points:'202,160 212,162 225,165 240,170 255,177 270,187 282,198 290,212 288,228 280,242 268,252 252,258 235,258 220,253 208,244 202,232 200,215 200,198' },
    // BICEPS
